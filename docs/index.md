...
The source code for your application can be found in [https://github.com/jrichter-rhtap/detect124 ](https://github.com/jrichter-rhtap/detect124 ).
 
The GitOps repository, which contains the Kubernetes manifests for the application can be found in 
[https://github.com/jrichter-rhtap/detect124-gitops ](https://github.com/jrichter-rhtap/detect124-gitops ). 
